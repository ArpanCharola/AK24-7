...
const ITEM = "flex items-center gap-2.5 w-full px-3 py-2 rounded-lg text-[13px] font-medium text-slate-600 hover:text-slate-900 hover:bg-muted/60 transition-colors";
...
export default function AvatarMenu() {
  ...
  return (
    <div className="relative" ref={ref}>
      ...
      {open && (
        <div className="absolute right-0 mt-2 w-56 glass-strong rounded-2xl p-1.5 z-50 animate-fade-in">
          ...
          <button onClick={logout} className={ITEM + " hover:!text-rose-600 hover:!bg-rose-50/70"}>
            <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.7}>
